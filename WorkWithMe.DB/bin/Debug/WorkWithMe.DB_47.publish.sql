...
GO
PRINT N'The following operation was generated from a refactoring log file fed7cd80-d1fb-4264-b5fa-724e52bf9560';

PRINT N'Rename [dbo].[tblUser].[UserImg] to UserImgId';


GO
EXECUTE sp_rename @objname = N'[dbo].[tblUser].[UserImg]', @newname = N'UserImgId', @objtype = N'COLUMN';
...
IF EXISTS (SELECT TOP 1 1 
           FROM   [dbo].[tblUser])
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_tblUser] ([Id], [Username], [PasswordHash], [PasswordSalt], [FirstName], [MiddleInitial], [LastName], [Zip], [Address], [IsAddressPrivate], [UserImgId], [EmailAddress])
        SELECT   [Id],
                 [Username],
                 [PasswordHash],
                 [PasswordSalt],
