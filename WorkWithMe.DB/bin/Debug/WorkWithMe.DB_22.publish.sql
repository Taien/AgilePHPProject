...
UNION
	SELECT Id, OwnerUserId, TargetGroupId, Title, Content, IsSticky, IsDeleted, 
	DATEDIFF(s,'1970-01-01 00:00:00',TimeStamp) as 'TimeStamp',
	DATEDIFF(s,'1970-01-01 00:00:00',EventTimeStamp) as 'EventTimeStamp' 
	from [dbo].[tblPost] 
	where OwnerUserId in (
		SELECT TargetUserId 
		from [dbo].[tblUserContact] 
		where OwnerUserId = @UserId and InviteStatusId = 2 -- 2 = accepted 
	)
