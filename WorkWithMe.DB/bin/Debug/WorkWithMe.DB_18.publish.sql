...
GO
/*
The type for column Id in table [dbo].[tblUserContact] is currently  INT NOT NULL but is being changed to  UNIQUEIDENTIFIER NOT NULL. There is no implicit or explicit conversion.
*/

IF EXISTS (select top 1 1 from [dbo].[tblUserContact])
    RAISERROR (N'Rows were detected. The schema update is terminating because data loss might occur.', 16, 127) WITH NOWAIT

GO
PRINT N'Starting rebuilding table [dbo].[tblUserContact]...';
...
CREATE TABLE [dbo].[tmp_ms_xx_tblUserContact] (
...
IF EXISTS (SELECT TOP 1 1 
    ...
    BEGIN
        INSERT INTO [dbo].[tmp_ms_xx_tblUserContact] ([Id], [OwnerUserId], [TargetUserId], [InviteStatusId])
        SELECT   [Id],
                 [OwnerUserId],
                 [TargetUserId],
                 [InviteStatusId]
...
DROP TABLE [dbo].[tblUserContact];

EXECUTE sp_rename N'[dbo].[tmp_ms_xx_tblUserContact]', N'tblUserContact';
...
exec spCreateUser @Username = 'Test',
 ...
 values
 (NewId(),'00000000-0000-0000-0000-000000000000','Test Post from User 0','Stuff A',false,false, GETDATE()),
 (NewId(),'00000000-0000-0000-0000-000000000001','Test Post from User 1','Stuff B',false,false, GETDATE());
GO
